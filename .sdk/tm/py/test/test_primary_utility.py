...
from projectname_sdk import CepikSDK
from projectname_sdk.core.spec import CepikSpec
from projectname_sdk.core.result import CepikResult
from projectname_sdk.core.response import CepikResponse
from projectname_sdk.core.operation import CepikOperation
from projectname_sdk.core.error import CepikError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CepikBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = CepikSDK.test(None, None)
        ...
        class TestInitFeature(CepikBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CepikBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CepikSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CepikSDK.test(None, setup_opts)
