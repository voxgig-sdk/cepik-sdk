...
// Cepik SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CepikMakeRequest
{
    public static function call(CepikContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CepikResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CepikResponse($fetched);
        } else {
