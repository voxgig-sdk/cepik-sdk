...
class CepikTimeoutFeature extends CepikBaseFeature
{
    ...
    private function _with_timeout(CepikContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CepikContext $_ctx, float $ms): void
    {
        $client = $this->client;
