...
class CepikNetsimFeature extends CepikBaseFeature
{
    ...
    private function _simulate(CepikContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CepikContext $ctx, array $applied): void
    {
        $client = $this->client;
