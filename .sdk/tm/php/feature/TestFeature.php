...
// Cepik SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CepikTestFeature extends CepikBaseFeature
{
    ...
    public function init(CepikContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CepikContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CepikContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CepikContext $ctx, $op, $args): array
    {
