...
|---|---|---|
| `ts/` | @voxgig-sdk/cepik-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/cepik-sdk \
      --repository voxgig-sdk/cepik-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/cepik-sdk` shows it, and
`npm trust revoke @voxgig-sdk/cepik-sdk --id=<id>` removes it.
