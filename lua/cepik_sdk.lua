...
CepikSDK._make_feature = _make_feature


function CepikSDK.new(options)
  local self = setmetatable({}, CepikSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function CepikSDK:get_utility()
  return Utility.copy(self._utility)
end


function CepikSDK:get_root_ctx()
  return self._rootctx
end


function CepikSDK:prepare(fetchargs)
...
function CepikSDK:direct(fetchargs)
...
-- by passing it.
function CepikSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CepikSDK:graphql(query, variables, ctrl)
...
function CepikSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = CepikSDK.new(sdkopts)
  sdk.mode = "test"
