...
describe("StatisticEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CEPIK_TEST_STATISTIC_ENTID JSON to run live")
      return
    end
...
function statistic_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CEPIK_TEST_STATISTIC_ENTID")
