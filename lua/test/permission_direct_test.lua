...
describe("PermissionDirect", function()
  it("should direct-list-permission", function()
    local setup = permission_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-permission", setup.live and "live" or "unit")
