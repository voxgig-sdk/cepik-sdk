...
describe("VehicleDirect", function()
  it("should direct-list-vehicle", function()
    local setup = vehicle_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-vehicle", setup.live and "live" or "unit")
