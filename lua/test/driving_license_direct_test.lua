...
describe("DrivingLicenseDirect", function()
  it("should direct-list-driving_license", function()
    local setup = driving_license_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-driving_license", setup.live and "live" or "unit")
