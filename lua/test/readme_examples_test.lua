...
-- data to return.
local TEST_SEED = '{ entity = { ["driving_license"] = { ["test01"] = { id = "test01" } }, ["permission"] = { ["test01"] = { id = "test01" } }, ["statistic"] = { ["test01"] = { id = "test01" } }, ["vehicle"] = { ["test01"] = { id = "test01" } } } }'
