...
local DrivingLicenseEntity = {}
DrivingLicenseEntity.__index = DrivingLicenseEntity


function DrivingLicenseEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DrivingLicenseEntity)
  self._name = "driving_license"
  self._client = client
...
function DrivingLicenseEntity:get_name()
  return self._name
end


function DrivingLicenseEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DrivingLicenseEntity.new(self._client, opts)
end
...
function DrivingLicenseEntity:mark_deleted()
  self._deleted = true
end


function DrivingLicenseEntity:deleted()
  return true == self._deleted
end


function DrivingLicenseEntity:data_set(args)
  if args ~= nil then
...
function DrivingLicenseEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DrivingLicenseEntity:match_set(args)
  if args ~= nil then
...
function DrivingLicenseEntity:match_get()
...
function DrivingLicenseEntity:stream(action, args, callopts)
...
function DrivingLicenseEntity:_run_op(ctx, post_done)
  local utility = self._utility
