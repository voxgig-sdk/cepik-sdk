...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/cepik` | `npm install @voxgig-sdk/cepik` |
| Python | `voxgig-sdk-cepik` | `pip install voxgig-sdk-cepik` |
| PHP | `voxgig-sdk/cepik` | `composer require voxgig-sdk/cepik` |
| Golang | `github.com/voxgig-sdk/cepik-sdk/go` | `go get github.com/voxgig-sdk/cepik-sdk/go` |
| Ruby | `voxgig-sdk-cepik` | `gem install voxgig-sdk-cepik` |
| Lua | `voxgig-sdk-cepik` | `luarocks install voxgig-sdk-cepik` |
