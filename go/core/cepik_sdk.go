...
func (sdk *CepikSDK) OptionsMap() map[string]any {
...
func (sdk *CepikSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CepikSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CepikSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CepikSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CepikSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CepikSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CepikSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CepikSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CepikSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CepikSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
