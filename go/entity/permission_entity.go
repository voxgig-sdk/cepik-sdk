...
func NewPermissionEntity(client *core.CepikSDK, entopts map[string]any) *PermissionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PermissionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PermissionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PermissionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PermissionListMatch and returns []Permission. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PermissionEntity) ListTyped(reqmatch PermissionListMatch, ctrl map[string]any) ([]Permission, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Permission](res), nil
}
...
func (e *PermissionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
