...
type DrivingLicenseEntity struct {
	name    string
	client  *core.CepikSDK
...
func NewDrivingLicenseEntity(client *core.CepikSDK, entopts map[string]any) *DrivingLicenseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DrivingLicenseEntity) GetName() string { return e.name }
...
func (e *DrivingLicenseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DrivingLicenseEntity) Deleted() bool {
	return e.deleted
}


func (e *DrivingLicenseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDrivingLicenseEntity(e.client, opts)
}

func (e *DrivingLicenseEntity) Data(args ...any) any {
...
func (e *DrivingLicenseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DrivingLicense; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DrivingLicenseEntity) DataTyped(data ...DrivingLicense) DrivingLicense {
	if len(data) > 0 {
		return typedFrom[DrivingLicense](e.Data(asMap(data[0])))
	}
	return typedFrom[DrivingLicense](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DrivingLicense (all fields
// optional at the wire level).
func (e *DrivingLicenseEntity) MatchTyped(match ...DrivingLicense) DrivingLicense {
	if len(match) > 0 {
		return typedFrom[DrivingLicense](e.Match(asMap(match[0])))
	}
	return typedFrom[DrivingLicense](e.Match())
}
...
func (e *DrivingLicenseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DrivingLicenseEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DrivingLicenseEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DrivingLicenseListMatch and returns []DrivingLicense. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DrivingLicenseEntity) ListTyped(reqmatch DrivingLicenseListMatch, ctrl map[string]any) ([]DrivingLicense, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[DrivingLicense](res), nil
}



func (e *DrivingLicenseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DrivingLicenseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DrivingLicenseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DrivingLicenseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
