...
func NewVehicleEntity(client *core.CepikSDK, entopts map[string]any) *VehicleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VehicleEntity) GetName() string { return e.name }
...
func (e *VehicleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VehicleEntity) Deleted() bool {
	return e.deleted
}


func (e *VehicleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVehicleEntity(e.client, opts)
}

func (e *VehicleEntity) Data(args ...any) any {
...
func (e *VehicleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *VehicleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VehicleEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *VehicleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *VehicleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VehicleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VehicleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VehicleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
