...
func TestStatisticEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set CEPIK_TEST_STATISTIC_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func statisticBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("CEPIK_TEST_STATISTIC_ENTID")
