...
const testSeed = `map[string]any{"entity": map[string]any{"driving_license": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "permission": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "statistic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vehicle": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
