...
The Golang SDK for the Cepik API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/cepik-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/cepik-sdk=../path/to/github.com/voxgig-sdk/cepik-sdk
```
...
```
github.com/voxgig-sdk/cepik-sdk/
...
The root package (`github.com/voxgig-sdk/cepik-sdk`) re-exports everything needed
