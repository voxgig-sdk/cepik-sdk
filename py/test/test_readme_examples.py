# Cepik SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CepikSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CepikSDK(...) and CepikSDK.test(...) become
#      CepikSDK.test({"entity": {...}}) seeding one mock record (id "test01")
