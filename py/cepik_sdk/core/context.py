...
from cepik_sdk.core.control import CepikControl
...
from cepik_sdk.core.helpers import get_ctx_prop, to_map
...
class CepikContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, CepikResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CepikError(code, msg, self)
