...
from cepik_sdk.utility import register

# Load features
from cepik_sdk.feature.base_feature import CepikBaseFeature
from cepik_sdk.features import _has_feature, _make_feature
...
class CepikSDK:
    ...
    def get_utility(self):
        return CepikUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CepikSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def DrivingLicense(self, data=None) -> "DrivingLicenseEntity":
        ...
        from cepik_sdk.entity.driving_license_entity import DrivingLicenseEntity
    ...
    def Permission(self, data=None) -> "PermissionEntity":
        ...
        from cepik_sdk.entity.permission_entity import PermissionEntity
    ...
    def Statistic(self, data=None) -> "StatisticEntity":
        ...
        from cepik_sdk.entity.statistic_entity import StatisticEntity
    ...
    def Vehicle(self, data=None) -> "VehicleEntity":
        ...
        from cepik_sdk.entity.vehicle_entity import VehicleEntity
