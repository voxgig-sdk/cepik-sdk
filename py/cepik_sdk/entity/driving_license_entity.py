...
from cepik_sdk.cepik_types import (
    DrivingLicense,
...
class DrivingLicenseEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DrivingLicenseEntity(self._client, opts)
    ...
    def data_get(self) -> DrivingLicense:
    ...
    def match_get(self) -> DrivingLicense:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DrivingLicense]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DrivingLicense().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
