...
class CepikTestRunner
{
    ...
    {
        $live = self::getenv('CEPIK_TEST_LIVE');
        $override = self::getenv('CEPIK_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CEPIK_TEST_EXPLAIN');
...
class_alias('CepikTestRunner', 'Runner');
class_alias('CepikHelpers', 'Helpers');
