...
// Cepik SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CepikSDK::test)
...
{
    private const SDK_CLASS = 'CepikSDK';
    ...
    private const SDK_BASE = 'cepik_sdk';
