...
class VehicleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VehicleEntity($this->_client, $opts);
    }

    /**
     * @param Vehicle|array $args Vehicle data (assoc-array) to store.
     */
    ...
    /**
     * @return Vehicle|array The current Vehicle data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Vehicle fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Vehicle fields).
     */
    ...
    /**
     * List Vehicle items matching the given filter.
     *
     * @param VehicleListMatch|array|null $reqmatch Match filter (any subset
     *   of Vehicle fields) as an assoc-array; VehicleListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Vehicle[]|array A list of Vehicle items as assoc-arrays at
