...
class PermissionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PermissionEntity($this->_client, $opts);
    }

    /**
     * @param Permission|array $args Permission data (assoc-array) to store.
     */
    ...
    /**
     * @return Permission|array The current Permission data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Permission fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Permission fields).
     */
    ...
    /**
     * List Permission items matching the given filter.
     *
     * @param PermissionListMatch|array|null $reqmatch Match filter (any subset
     *   of Permission fields) as an assoc-array; PermissionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Permission[]|array A list of Permission items as assoc-arrays at
