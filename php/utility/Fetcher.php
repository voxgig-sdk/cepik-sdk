...
class CepikFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CepikSDK/1.0)';
    ...
    public static function call(CepikContext $ctx, string $fullurl, array $fetchdef): array
    {
