...
The PHP SDK for the Cepik API — an entity-oriented client using PHP conventions.
...
try {
    ...
    foreach ($drivinglicenses as $record) {
...
| `wgkategorii` | `array` | Breakdown by license category |
| `wgmarki` | `array` | Breakdown by brand |
| `wgrodzaju` | `array` | Breakdown by vehicle type |
| `wojewodztwo` | `string` | Province/voivodeship |
...
The main class (`cepik_sdk.php`) exports the SDK class
