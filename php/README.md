...
The PHP SDK for the Cepik API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->DrivingLicense(null)->list(null, null);
...
[$result, $err] = $client->Cepik(null)->load(
    ["id" => "test01"], null
);
