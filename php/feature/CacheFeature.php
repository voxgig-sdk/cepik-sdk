...
class CepikCacheFeature extends CepikBaseFeature
{
    ...
    private function _through(CepikContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
