...
class CepikRatelimitFeature extends CepikBaseFeature
{
    ...
    private function _acquire(CepikContext $ctx): void
    {
    ...
    private function _track(CepikContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
