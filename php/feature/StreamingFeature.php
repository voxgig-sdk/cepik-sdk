...
class CepikStreamingFeature extends CepikBaseFeature
{
    ...
    private function _iterate(CepikResult $result): \Generator
    {
    ...
    private function _streamable(CepikContext $ctx): bool
    {
