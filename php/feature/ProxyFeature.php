...
class CepikProxyFeature extends CepikBaseFeature
{
    ...
    public function init(CepikContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CepikContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
