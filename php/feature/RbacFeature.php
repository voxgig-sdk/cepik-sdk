...
class CepikRbacFeature extends CepikBaseFeature
{
    ...
    private function _required(CepikContext $ctx): ?string
    {
    ...
    private function _reject(CepikContext $ctx, string $required): void
    {
    ...
    private function _track(CepikContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
