...
(0, node_test_1.describe)('DrivingLicenseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-driving_license', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-driving_license', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CEPIK_TEST_DRIVING_LICENSE_ENTID'];
...
//# sourceMappingURL=DrivingLicenseDirect.test.js.map