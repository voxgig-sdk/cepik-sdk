...
(0, node_test_1.describe)('VehicleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-vehicle', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-vehicle', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CEPIK_TEST_VEHICLE_ENTID'];
...
//# sourceMappingURL=VehicleDirect.test.js.map