...
(0, node_test_1.describe)('PermissionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-permission', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-permission', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CEPIK_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'CEPIK_TEST_PERMISSION_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.CepikSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CEPIK_TEST_PERMISSION_ENTID'];
...
//# sourceMappingURL=PermissionDirect.test.js.map