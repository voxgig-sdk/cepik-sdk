...
describe('DrivingLicenseDirect', async () => {
  ...
  test('direct-list-driving_license', async (t: any) => {
    if (liveScenariosActive()) { t.skip('Covered by live operation scenarios'); return }
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-driving_license', setup.live)) return
