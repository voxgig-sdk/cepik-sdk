...
exports.CepikEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends CepikEntityBase<Advice>`.
class CepikEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.CepikEntityBase = CepikEntityBase;
//# sourceMappingURL=CepikEntityBase.js.map