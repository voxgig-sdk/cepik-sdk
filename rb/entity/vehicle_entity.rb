...
class VehicleEntity
  ...
  def make
    opts = @_entopts.dup
    VehicleEntity.new(@_client, opts)
  end
  ...
  # @return [Vehicle, Hash] the current Vehicle data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Vehicle fields)
  def match_get
  ...
  #
  # @param reqmatch [VehicleListMatch, Hash, nil] match filter (any subset of
  #   Vehicle fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Vehicle>, Array] the matching Vehicle items; raises CepikError on failure
