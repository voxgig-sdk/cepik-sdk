...
class StatisticEntity
  ...
  # @return [Statistic, Hash] the loaded Statistic; raises CepikError on failure
    ...
    _run_op(ctx) do
      if ctx.result
        ...
        if ctx.result.resdata
          @_data = CepikHelpers.to_map(VoxgigStruct.clone(ctx.result.resdata)) || {}
        end
      end
    end
  end
