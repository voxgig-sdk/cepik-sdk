...
class PermissionEntity
  ...
  def make
    opts = @_entopts.dup
    PermissionEntity.new(@_client, opts)
  end
  ...
  # @return [Permission, Hash] the current Permission data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Permission fields)
  def match_get
  ...
  #
  # @param reqmatch [PermissionListMatch, Hash, nil] match filter (any subset of
  #   Permission fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Permission>, Array] the matching Permission items; raises CepikError on failure
