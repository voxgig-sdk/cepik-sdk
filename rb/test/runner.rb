...
module CepikTestRunner
  ...
  def self.env_override(m)
    live = getenv("CEPIK_TEST_LIVE")
    override = getenv("CEPIK_TEST_OVERRIDE")
    ...
    explain = getenv("CEPIK_TEST_EXPLAIN")
    m["CEPIK_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CepikTestRunner
Helpers = CepikHelpers
Vs = VoxgigStruct
